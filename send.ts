...
*/
  {
    address: "EQD7VspHSNS4VSpN7QQicNgSYoJ68CmdC6oL5ZEKHSXe26Sa",
    reward: 10000,
  },
  {
    address: "EQC5uEgW0MkTbCRBZB72maxCZT3m14OK2FcSLVr2H_7MTTSF",
    reward: 10000,
  },
  {
    address: "EQC2nD9nQNRhcfWhdBzRK-wdlTO4hGxnPFzdSxKN777tab2_",
    reward: 10000,
  },
  {
    address: "EQAqd4vV0O5oGfA7bl6fVORD_Y4PTNZG82AC2BObBux51g2w",
    reward: 10000,
  },
  {
...
async function main() {
  ...
  while (go) {
    ...
    const command = `./pow-miner-cuda -g 0 -F 256 -t 5 ${wallet.address.toString(
      {
        urlSafe: true,
        bounceable: true,
      }
